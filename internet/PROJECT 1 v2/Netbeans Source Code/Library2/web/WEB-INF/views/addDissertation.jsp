...
<script>
    function myFunction() {
        if (document.getElementById("librarianstatusId").value == 2)
    ...
    <body style="background-color: antiquewhite">
        ...
        <c:set var="canAdd" scope="request" value="${newDissertation.lastSubmission.librarianstatusId == 2}"/>
    ...
    <form:form id="frmDissertation" method="post" enctype="multipart/form-data" modelAttribute="newDissertation" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-8">
                <input type="submit" id="btnAdd" value ="Add" name="action" class="btn btn-primary" disabled="${canAdd}"/>
