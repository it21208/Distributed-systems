...
<html>
    ...
    <form:form modelAttribute="modifyUser" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                True <form:radiobutton path="onlinesubmit" value="true"/>
                False <form:radiobutton path="onlinesubmit" value="false"/>                
            </div>
        </div>            
        <div class="form-group">
