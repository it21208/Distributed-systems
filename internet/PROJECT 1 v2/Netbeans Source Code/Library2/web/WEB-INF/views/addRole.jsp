...
<html>
    ...
    <form:form modelAttribute="newRole" class="form-horizontal">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-1">
                <form:input id="name" path="minUsers" type="text" class="form-control"/>
            </div>
        </div>
        <div class="form-group">
            <label class="control-label col-sm-2" for="id">Max Users:</label>
            <div class="col-sm-1">
                <form:input id="name" path="maxUsers" type="text" class="form-control"/>
            </div>
        </div>
        <div class="form-group">
